...
public class PyMarketPlaceConsumer {
    ...
    public static void main(String[] args) {
        ...
        try (Jedis jedis = RedisConfig.getJedis()) {
            while (true) {
                ...
                if (mensagem != null) { // isso aq faz o horario em que a msg é consumida x 45min pra definir o horario de entrega
                    LocalDateTime agora = LocalDateTime.now();
                    LocalDateTime entregaPrevista = agora.plusMinutes(45);
